...
const UpdateProfile = () => {
    ...
    const onSubmit = async data => {
        ...
        fetch(`https://salty-island-81432.herokuapp.com/myProfile/${user.email}`, {
            method: "PATCH",
            headers: {
    ...
    return (
        <div>
            <h2 className='text-3xl font-bold text-secondary'>Update Profile</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="btn btn-primary form-control w-full max-w-xs mt-2" type="submit" value='Update Profile' />
            </form>
        </div>
    )
}
